...
```
saving roachstation.dmb (DEBUG mode)
roachstation.dmb - 0 errors, 0 warnings
```
...
compiled roachstation.dmb file. Make sure to set the port to the one you
...
If you'd like a more robust server hosting option for roachstation and its
derivatives. Check out tgstation server tools suite at
