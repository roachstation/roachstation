...
export class Changelog extends Component {
  ...
  render() {
    ...
    const header = (
      <Section>
        <h1>Empty, currently</h1>
        <p>Dont worry, we are working very hard to fulfill here.</p>
      </Section>
    );
    ...
    const footer = (
      <Section>
        {dateDropdown}
        <h3>RoachStation Development Team</h3>
        <p>
          <b>Coders: </b>
          might4, depresif, umut25
        </p>
        <p>
          <b>Spriters: </b>
          4sud.gy, Rude Arcade Machine, Vienna
        </p>
        <p>
          You can find our LICENSE that we are dealing with right <a href="https://github.com/roachstation/roachstation/blob/main/README.md#license">here</a>.
        </p>
      </Section>
    );
    // const header = (
    ...
    // No logged changes currently, we can write it back with {changes} tag to line 364
    return (
