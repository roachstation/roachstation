...
/datum/mafia_role/proc/greet()
	...
	to_chat(body, "<span class='warningplain'><b>Be sure to read <a href=\"https://roachstation.github.io/wiki
Mafia\">the wiki page</a> to learn more, if you have no idea what's going on.</b></span>")
